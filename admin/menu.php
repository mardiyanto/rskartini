...
<li class='treeview'>
               ...
               <ul class='treeview-menu'>
                ...
                <li><a href='index.php?aksi=slide'><i class='fa fa-arrows-h'></i>SLIDE</a></li>
                <li><a href='index.php?aksi=halaman'><i class='fa fa-arrows-h'></i>HALAMAN</a></li>
                <li><a href='index.php?aksi=poli'><i class='fa fa-arrows-h'></i>POLI</a></li>
                ...
                <li><a href='index.php?aksi=alumni'><i class='fa fa-arrows-h'></i>TESTIMONI</a></li>
                <li><a href='index.php?aksi=pegawai'><i class='fa fa-arrows-h'></i>DOKTER</a></li>
               </ul>
</li>
